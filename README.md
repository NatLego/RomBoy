...
<table>
<tr>
<td width="33%"><img src="images/01-Your-games-in-your-hands.png" alt="RomBoy gameplay in the Pixel skin, shown in a phone mock-up" width="300"></td>
<td width="33%"><img src="images/02-Plug-in-play-on.png" alt="RomBoy on a phone fitted with a Backbone controller" width="300"></td>
<td width="33%"><img src="images/05-Make-it-your-RomBoy.png" alt="Customisable RomBoy gameplay skins, shown in phone mock-ups" width="300"></td>
</tr>
</table>
...
<table>
<tr>
<td width="33%"><img src="images/03-Add-games-from-your-phone.png" alt="Importing games from your phone into RomBoy" width="300"></td>
<td width="33%"><img src="images/04-Your-library-ready-to-play.png" alt="RomBoy's server connection screen, with example addresses masked" width="300"></td>
<td width="33%"><img src="images/06-Your-phone-your-playground.png" alt="RomBoy's home screen shown within a straight phone frame" width="300"></td>
</tr>
<tr>
<td width="33%"><img src="images/07-Bright-games-dark-mode.png" alt="RomBoy's dark appearance shown in a phone mock-up" width="300"></td>
<td width="33%"><img src="images/08-Your-games-hands-on.png" alt="RomBoy being played on a phone with a Backbone controller" width="300"></td>
<td width="33%"><strong>Follow the development</strong><br><br>See what is available in the current build, what is planned next, and how to share feedback.<br><br><a href="ROADMAP.md">View the roadmap</a><br><a href="SUPPORT.md">Support and feedback</a></td>
</tr>
</table>
